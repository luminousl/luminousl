0.0032484233379364014 / 0.0009231804287992418 *0.007742395158857107
...
# lat_dict_2 = analys("/data2/model_opt/UNIFIED_3d_v8/0529/TASK01100000111_v8.0_lr24_f120_7cam_sim_int8opt_plugin.processed.orin/TASK01100000111_v8.0_lr24_f120_7cam_sim_int8opt_plugin.processed")
# lat_dict_1 = analys("/data2/model_opt/UNIFIED_3d_v8/0530/TASK01100000110_v8.0_lr24_f120_7cam_bifpn_noattention_sim_int8opt_plugin.orin.orin/TASK01100000110_v8.0_lr24_f120_7cam_bifpn_noattention_sim_int8opt_plugin.orin")
# lat_dict_1 = analys("/data2/model_opt/UNIFIED_3d_v8/0609_quant_test/v8_3d_quant.orin/v8_3d_quant")

# lat_dict_2 = analys("/data2/model_opt/UNIFIED_3d_v8/0609_quant_test/v8_3d_quant.orin/v8_3d_quant")
# lat_dict_1 = analys("/data2/model_opt/UNIFIED_3d_v8/0610_test_convgru/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin")
profile_list = [
    "/data2/model_opt/UNIFIED_3d_v8/0610_test_convgru/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0611_channel_adjust/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0611_channel_adjust_v2/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0611_channel_adjust_v3/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_bevformer_sim_int8opt_plugin.orin",
    "/media/models/sorin/0520_v6.40/01_unifiedmodel_v6.40.orin/UNIFIED_v6.40_Lanemark24m47kLane24m50kCurb6.26Pend50kArrow18kCenter30kLR19kUturn18kBase6.34_sim_int8opt_plugin_qdqopt_1747643872",
    "/data2/model_opt/sorin/v6_0624/mgl.trt_profile/mgl",
    "/data2/model_opt/sorin/0626/unified_model.orin/unified_model"
]
lat_dict_old = analys(profile_list[-2])
lat_dict_new = analys(profile_list[-1])
print("==============")

for k in lat_dict_old.keys():
    if abs(lat_dict_old[k]-lat_dict_new[k]) > 0.05:
        print(f"{k:<40s}  {lat_dict_old[k]:>5.1f} {lat_dict_new[k]:>5.1f}  {lat_dict_new[k] - lat_dict_old[k]:>5.1f} " )
    else:
        print(f"{k:<40s}  {lat_dict_old[k]:>5.1f} {lat_dict_new[k]:>5.1f}  " )
...
lat_dict_1 = analys("/data2/model_opt/UNIFIED_2d_v7/v7.10_allgpu/_all_V8.0_2D_one_model_int8_seq_addm1depth_sim_opt_plugin_7ae00b.processed.cutplugin")
...
/bevmap/img_bev_encoder_backbone/layers.0/layers.0.0/conv1/_input_quantizer/QuantizeLinear
/bevocc/img_bev_encoder_backbone/layers.0/layers.0.0/conv1/_input_quantizer/QuantizeLinear
...
# lat_dict_1 = analys("/media/models/unified_3d/0513_v7_7cam/UNIFIED_3d_7cam.orin/7cam_orinY_sim_int8opt_qdqopt")
# lat_dict_2 =analys("/data2/model_opt/orinY/0529_orinY_3d_v2/TASK01100000110_OrinY_sim_int8opt.orinv2.orin/TASK01100000110_OrinY_sim_int8opt.orinv2")

profile_list = [
    "/data2/model_opt/UNIFIED_3d_v8/0616_seq_test/TASK01100000110_V8_seq1_int8_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_seq1_int8_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0616_seq_test/TASK01100000110_V8_seq0_int8_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_seq0_int8_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0616_seq_test/TASK01100000110_V8_seq2_int8_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_seq2_int8_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0618_caihongyu_test/TASK01100000110_V8_seq2_conv_int8_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_seq2_conv_int8_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0618_caihongyu_test/TASK01100000110_V8_seq2_te_int8_sim_int8opt_plugin.orin.orin/TASK01100000110_V8_seq2_te_int8_sim_int8opt_plugin.orin",
    "/data2/model_opt/UNIFIED_3d_v8/0627_bevformer/TASK01100000110_V8_bevformer_sim.orin/TASK01100000110_V8_bevformer_sim",
    "/data2/model_opt/UNIFIED_3d_v7/TASK01100000110_OrinY_0619_sim_int8opt_plugin.orin.orinY/TASK01100000110_OrinY_0619_sim_int8opt_plugin.orin",
#     "/data2/model_opt/sorin/0707_HQ/0702_env_cognition_7.1_cam7_mul_100m_hdmap_fusion_pre_01_other_11_post_2_6_cb661c86_optqat_1751428499.orin/0702_env_cognition_7.1_cam7_mul_100m_hdmap_fusion_pre_01_other_11_post_2_6_cb661c86_optqat_1751428499"
    "/data2/model_opt/UNIFIED_3d_v7/0708_aux_lidar/20250702-1516__TASK01100000110_OrinY_0619_sim_int8opt_plugin.orin_qdq_orinY/TASK01100000110_OrinY_0619_sim_int8opt_plugin.orin_qdq",
    "/data2/model_opt/UNIFIED_3d_v7/0708_aux_lidar/TASK01100000110_OrinY_sim_int8opt_plugin.orin.orinY/TASK01100000110_OrinY_sim_int8opt_plugin.orin",
]
lat_dict_old = analys(profile_list[-2])
lat_dict_new = analys(profile_list[-1])
print("==============")
...
#                 'bev_hdmap_fusion',
                ...
                'turn_guideline_head',
                'bev_head',
                'multi_guideline_head',
                'image_seg_head',
                'centerline_head_aux',
                'bev_seg_downsample_aux',
                'bev_seg_downsample',
                'centerline_mark_head',
                'arrow_head',
                'pending_head',
                'bev_occ_head',
