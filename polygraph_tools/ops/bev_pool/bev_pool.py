...
class QuickCumsumCuda(torch.autograd.Function):
    ...
    def forward(ctx, depth, feat, ranks_depth, ranks_feat, ranks_bev,
        ...
        bev_pool_v2_ext.bev_pool_v2_forward(
            depth, # torch.Size([1, 8, 72, 64, 120])
            feat,  # torch.Size([1, 8, 64, 64, 120])
            out,   # torch.Size([1, 1, 256, 64, 64])
            ranks_depth, # torch.Size([766])
            ranks_feat, # torch.Size([766])
            ranks_bev, # torch.Size([766])
            interval_lengths, # torch.Size([633])
            interval_starts, # torch.Size([633])
        )
