...
def FakeDataGenerator(shape, directory, num):
    """
...
def main():
    ...
    parser.add_argument("--explicit-batch", default="True", action='store_true', help="Set trt.NetworkDefinitionCreationFlag.EXPLICIT_BATCH.")
    ...
    parser.add_argument("--calibration-batch-size", help="(INT8 ONLY) The batch size to use during calibration.", type=int, default=2)
    parser.add_argument("--max-calibration-size", help="(INT8 ONLY) The max number of data to calibrate on from --calibration-data.", type=int, default=10)
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        # config.max_workspace_size = 10*2**30 # 1GiB
